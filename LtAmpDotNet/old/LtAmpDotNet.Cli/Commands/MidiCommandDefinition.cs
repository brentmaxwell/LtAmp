...
namespace LtAmpDotNet.Cli.Commands
{
    internal class MidiCommandDefinition : BaseCommandDefinition
    {
        ...
        internal void Amp_MessageReceived(object? sender, Lib.Events.FenderMessageEventArgs e) => Console.WriteLine($"[AMP ] {e.Message}");

        internal void Amp_CurrentPresetStatusMessageReceived(object? sender, Lib.Events.FenderMessageEventArgs e) => currentPreset = Preset.FromString(e.Message!.CurrentPresetStatus.CurrentPresetData)!;
