...
namespace LtAmpDotNet.Controls
{
    public class FixedWrapPanel : Panel, INavigableContainer
    {
        public static readonly StyledProperty<int> ItemsPerLineProperty =
            AvaloniaProperty.Register<FixedWrapPanel, int>(nameof(ItemsPerLine), 2);
        ...
        IInputElement INavigableContainer.GetControl(NavigationDirection direction, IInputElement? from, bool wrap)
        {
            ...
            return index >= 0 && index < Children.Count ? Children[index] : (IInputElement)this;
        }
        ...
        private struct MutableSize
        {
            ...
            internal Size ToSize() => new(Width, Height);
        }
    }
}
